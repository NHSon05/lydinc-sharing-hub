...
export default function ProjectsError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error('Projects list error boundary caught:', error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center p-12 text-center border border-rose-900/40 rounded-2xl bg-rose-950/10">
      ...
      <p className="text-xs text-zinc-400 max-w-sm mb-6 leading-relaxed">
        Đã xảy ra lỗi trong quá trình giao tiếp với máy chủ. Vui lòng kiểm tra lại quyền truy cập hoặc thử lại.
      </p>
