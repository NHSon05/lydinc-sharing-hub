...
import type { PaginationInfo } from './department-ui.types';

interface DepartmentPaginationProps {
  pagination: PaginationInfo;
}

export function DepartmentPagination({ pagination }: DepartmentPaginationProps) {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2 text-xs text-zinc-400">
      <div>
        Hiển thị tổng số <span className="font-semibold text-zinc-200">{totalItems}</span> phòng ban
      </div>
