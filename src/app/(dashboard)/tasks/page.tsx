      ...
      <div className="flex items-center justify-between border-b border-zinc-800 pb-5">
        <div>
          ...
          <p className="text-xs text-zinc-400 mt-1">
            Danh sách và trạng thái các nhiệm vụ trong dự án.
          </p>
        </div>
              ...
              {tasks.length > 0 ? (
                tasks.map((task) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-6">
                      <span
                        className={`inline-flex px-2 py-0.5 rounded-full text-[10px] font-bold border uppercase tracking-wider ${getPriorityClass(task.priority)}`}
                      >
                        {task.priority}
                      </span>
                    </td>
                    ...
                    <td className="py-4 px-6">
                      <span
                        className={`inline-flex px-2 py-0.5 rounded-full text-[10px] font-bold border uppercase tracking-wider ${getStatusClass(task.status)}`}
                      >
                        {task.status}
                      </span>
                    </td>
